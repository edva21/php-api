...
CREATE TABLE `item` (
  ...
  `telefonoOficina_fac` VARCHAR(30),
...
INSERT INTO item(id, servicio, nombreDeContacto, correoElectronico1, correoElectronico2, empresa, telefono, direccion,
                 ...
                 telefonoOficina_factest1","numeroReserva_factest1",CURRENT_TIMESTAMP,MD5("1")),(2,"serviciotest2","nombreDeContactotest2",
                ...
                current_date,"tipoUnidad1test2",0,"tipoUnidad2test2","descripcionDeMercanciatest2","razonSocial_factest2","
                 ...
                 telefonoOficina_factest2","numeroReserva_factest2",CURRENT_TIMESTAMP,MD5("2")),(3,"serviciotest3","nombreDeContactotest3",
                ...
                current_date,"tipoUnidad1test3",0,"tipoUnidad2test3","descripcionDeMercanciatest3","razonSocial_factest3","
                 ...
                 telefonoOficina_factest3","numeroReserva_factest3",CURRENT_TIMESTAMP,MD5("3")),(4,"serviciotest4","nombreDeContactotest4",
                ...
                current_date,"tipoUnidad1test4",0,"tipoUnidad2test4","descripcionDeMercanciatest4","razonSocial_factest4","
                 ...
                 telefonoOficina_factest4","numeroReserva_factest4",CURRENT_TIMESTAMP,MD5("4"));